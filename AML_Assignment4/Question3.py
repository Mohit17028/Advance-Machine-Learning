...
#         ingle_img_reshaped= cv2.resize(ingle_img_reshaped, dsize=(197,197), interpolation=cv2.INTER_CUBIC)
...
testLoader= data_utils.DataLoader(testLoader, batch_size=50, shuffle=True)
...
pkl.dump(acc_test,open("acc_test.pkl","wb"))
pkl.dump(acc_train,open("acc_train.pkl","wb"))
pkl.dump(ep,open("ep.pkl","wb"))
pkl.dump(loss_test,open("loss_test.pkl","wb"))
pkl.dump(loss_train,open("loss_train.pkl","wb"))
